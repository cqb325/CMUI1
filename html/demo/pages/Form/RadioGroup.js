define(['module', 'react', '../BaseDemo', 'classnames', 'Input', 'RadioGroup', "../Tile"], function (module, React, BaseDemo, classnames, Input, RadioGroup, Tile) {
    'use strict';
            ...
            value: function render() {
                ...
                return React.createElement(
                    ...
                    React.createElement(
                        Tile,
                        { header: "基本样例" },
                        React.createElement(RadioGroup, { data: groupData, value: '0', onChange: checkBoxChange }),
                        React.createElement(
                            'pre',
                            { className: 'brush: xml', ref: 'code1' },
                    ...
                    React.createElement(
                        Tile,
                        { header: "堆积布局" },
                        React.createElement(RadioGroup, { data: groupData2, value: '0', onChange: checkBoxChange, layout: 'stack', valueField: 'type', textField: 'name' }),
                        React.createElement(
                            'pre',
                    ...
                    React.createElement(
                        Tile,
                        { header: "禁用" },
                        React.createElement(RadioGroup, { data: groupData2, value: '0', valueField: 'type', textField: 'name', disabled: true }),
                        React.createElement(
                            'pre',
