define(['module', 'react', 'react-dom'], function (module, React, ReactDOM) {
    ...
    var BaseDemo = function (_Component) {
        _inherits(BaseDemo, _Component);

        function BaseDemo() {
            _classCallCheck(this, BaseDemo);

            return _possibleConstructorReturn(this, Object.getPrototypeOf(BaseDemo).apply(this, arguments));
        }
